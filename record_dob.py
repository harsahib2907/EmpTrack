...
class Record3_class:
    def __init__(self,window):
        ...
        self.e1 = DateEntry(self.window, borderwidth=2, year=2000, date_pattern='y-mm-dd', background=mycolor3,
                            foreground=mycolor4, font=myfont1)
        self.e2 = DateEntry(self.window, borderwidth=2, year=2000, date_pattern='y-mm-dd', background=mycolor3,
                            foreground=mycolor4, font=myfont1)
        #----------------------Table------------------------
        ...
        self.b2.place(x=x1 + xdiff *2+50, y=y1,height=30)
        y1 += ydiff
    ...
    def Get_All_Data(self):
        try:
            qry="select * from empolyees where dob between %s and %s"
            rowcount=self.curr.execute(qry,(self.e1.get_date(),self.e2.get_date()))
    ...
    def getprintout(self):
        ...
        pdf.content(f"Employee Record by DOB From {self.e1.get_date()} To {self.e2.get_date()}", headings, self.pdata)
