...
class Record_class:
    ...
    def Get_All_Data(self):
        try:
            ...
            if data:
                for row in data:
                    myrow=[row[0],row[1],row[2],row[3],row[4],row[5],row[6],row[9]]
    ...
    def getprintout(self):
        ...
        headings = ['Employee Id', 'Name', 'Designation', 'Department', 'DOB', 'Phone No.', 'E-Mail', 'Salary']


        pdf.content("Student Record", headings, self.pdata)
