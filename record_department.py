...
class Record2_class:
    def __init__(self,window):
        ...
        self.c1.bind("<<ComboboxSelected>>", lambda e: self.Get_All_Data())
        #----------------------Table------------------------
    ...
    def Get_All_Data(self):
        try:
            qry="select * from empolyees where department=%s"
    ...
    def getprintout(self):
        ...
        pdf.content(f"Employee Record by Department {self.v2.get()}", headings, self.pdata)
